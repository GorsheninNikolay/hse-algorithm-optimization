...
def branch_and_bound(c, A, b):
    ...
    while active_nodes:
        ...
        wizards, knights, dragons, value = simplex.simplex_method(c, current_A, current_b)
...
if __name__ == '__main__':
    ...
    print(f'Маги={wizards}, Рыцарей={knights}, Драконов={dragons}, целевое значение={best_value}')
